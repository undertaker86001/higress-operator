...
func (in *KEDAScalingConfig) DeepCopyInto(out *KEDAScalingConfig) {
	*out = *in
	if in.PollingIntervalSeconds != nil {
		in, out := &in.PollingIntervalSeconds, &out.PollingIntervalSeconds
		*out = new(int32)
		**out = **in
	}
	...
	if in.Triggers != nil {
		...
		*out = make([]KEDAScaleTrigger, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KEDAScaleTrigger) DeepCopyInto(out *KEDAScaleTrigger) {
	*out = *in
	if in.Metadata != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KEDAScaleTrigger.
func (in *KEDAScaleTrigger) DeepCopy() *KEDAScaleTrigger {
	if in == nil {
		return nil
	}
	out := new(KEDAScaleTrigger)
	in.DeepCopyInto(out)
	return out
}
